...
const BottomNavigation = ({ setActivePage}) => {
  ...
  // когда URL меняется — обновляем активный индекс
  useEffect(() => {
...
<path d="M11 11C14.0376 11 16.5 8.53757 16.5 5.5C16.5 2.46243 14.0376 0 11 0C7.96243 0 5.5 2.46243 5.5 5.5C5.5 8.53757 7.96243 11 11 11Z"/>
  ...
  return (
    <>
      {/* полоска‑индикатор над кнопками */}
      

      {/* сами навигационные кнопки */}
        ...
        {buttons.map((button, idx) => (
          <div
            ...
            style={{
              ...
              color: activeIndex === idx ? "white" : "gray"
            }}
          >
