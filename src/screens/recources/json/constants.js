...
export const TEAM_SOCIAL = {
  ...
  export const CONSTRUCTOR_API_NAMES = {
    "Red Bull": "red_bull",
    "McLaren": "mclaren",
    "Ferrari": "ferrari",
...
export const TEAM_COLORS = {
  ...
  export const TEAM_BIOGRAPHIES = {
    ...
    "RB F1 Team": "RB Racing – это технически другая команда, часто связанная с Red Bull Racing, особенно в контексте используемых технологий.",
